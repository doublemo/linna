...
import (
	...
	naruntime "github.com/doublemo/linna-common/runtime"
	"go.uber.org/zap"
)
...
func NewRuntimeGoLogger(logger *zap.Logger) naruntime.Logger {
...
func (l *RuntimeGoLogger) WithField(key string, v interface{}) naruntime.Logger {
	return l.WithFields(map[string]interface{}{key: v})
}

func (l *RuntimeGoLogger) WithFields(fields map[string]interface{}) naruntime.Logger {
